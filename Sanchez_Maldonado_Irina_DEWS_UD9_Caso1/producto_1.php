...
<body>
    <div class="row">
        <div class="col-sm-4">
            <div class="card">
                <div class="card-body">
                    <img src="reloj_muñeca.jpg" alt="" />
                    <h5 class="card-title">Reloj analógico de muñeca</h5>
                    <p class="card-text">
                        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Non
                        rerum accusantium sint recusandae tempora officia, delectus...
                    </p>
                    <form action="carrito.php?nombre=Reloj de muñeca" method="POST">
                        <label>Reloj de muñeca</label>
                        <p>Cantidad:
